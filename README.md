...
1. Place [ResoGifImporter.dll](https://github.com/zahndy/FasterBadges/releases/latest/download/ResoGifImporter.dll) and [SixLabors.ImageSharp.dll](https://github.com/zahndy/FasterBadges/releases/latest/download/SixLabors.ImageSharp.dll) into your `rml_mods` folder. This folder should be at `C:\Program Files (x86)\Steam\steamapps\common\Resonite\rml_mods` for a default install. You can create it if it's missing, or if you launch the game once with ResoniteModLoader installed it will create the folder for you.
